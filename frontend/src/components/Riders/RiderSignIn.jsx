                        ...
                        <div className=" bg-white p-8 flex flex-col gap-5 w-full mb-16 rounded-b-2xl">
                            ...
                            <form action="" onSubmit={handleSubmit}>
                                ...
                                <div className=" flex flex-col gap-3">
                                    ...
                                    <FormContent title="Phone Number*" type="tel" id="phone_number" autoComplete="number" placeholder="+23412345678" instruction="" value={formValue.phone_number} onChange={handleInput} />
