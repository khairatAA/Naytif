                ...
                <div className=" flex flex-row gap-10 flex-wrap max-md:justify-center">
                    {
                        sortedRestaurants.map((restaurant, index) => (
                            <div key={restaurant.id} className=" flex flex-col gap-5">
                                <div key={restaurant.id} className=" rounded-xl">
                                    {restaurant.image_url ? (
                                        <img src={restaurant.image_url} alt="Restaurant image" className=" w-56 rounded-xl " />
                                        ) : (
                                            <img src={Restaurant1} alt="Restaurant image alternative" />
                                    )}
                                </div>
