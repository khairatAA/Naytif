...
import naytifDefault from "../../assets/naytifGreen.png";
    ...
    return (
        <div className=" bg-green flex flex-col h-screen">
            <div className=" py-5 pl-5" style={{ boxShadow: '0 4px 8px rgba(0, 0, 0, 0.25)' }}>
                <h1 className="font-logo text-yellow text-4xl leading-7 font-bold"><a href="/"><img src={naytifDefault} className="h-10 w-15 fill-slate-300" alt="Naytif" /></a></h1>
            </div>
            <div className=" flex flex-col justify-center items-center h-full px-10">
                <div className=" flex flex-row max-sm:flex-col justify-center items-center gap-5 p-5 bg-[rgba(255,255,255,30%)]  rounded-2xl border border-green">
                    ...
                    <div className=" flex flex-col justify-center items-start gap-5">
                        ...
                        <h2 className=" text-lg font-medium">Go ahead to log in <Link to="/auth/restuarants/login" className=" text-yellow"><u>here</u></Link></h2>
                    </div>
                </div>
            </div>
        </div>
