        ...
        <div className=" ml-72 max-md:ml-16 px-5 bg-powder-blue w-full py-5 flex flex-col gap-14 ">
            ...
            <div className=' self-center p-8 rounded-xl bg-light-green flex flex-col gap-8 w-3/4 max-md:w-11/12'>
                ...
                <form action="" onSubmit={handleSubmit} className=' flex flex-col gap-5' >
                    ...
                    <FormContentCustomBg title='Menu Item Name' id='menu_item_name' type='text' instruction='Do not exceed 20 characters when entering the menu  name' value={formValue.menu_item_name} onChange={handleInput} />
                    ...
                    <FormContentCustomBg title='Price' id='price' type='number' instruction='This is how the price will appear in the app.' placeholder='Example: #5000' value={formValue.price} onChange={handleInput} />
